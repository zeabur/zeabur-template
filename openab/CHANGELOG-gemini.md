...
- 新增 OpenAB Gemini 模板（Discord → Gemini CLI 透過 ACP 橋接）
- 使用 `ghcr.io/openabdev/openab-gemini` 映像，預設 agent 後端為 `gemini --acp`
- 使用 Google AI Studio 取得的 Gemini API key 認證
